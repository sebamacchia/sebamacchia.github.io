...
})(
  {
    1: [
      function (t, n, r) {
        "use strict";
        t(2);
        var e = (function _interopRequireDefault(
          t
        ) {
    ...
    67: [
      function (t, n, r) {
        ...
        n.exports = function flattenIntoArray(
          t,
          n,
          r,
          e,
        ...
        var e = t(140),
          ...
          u =
            ...
            Object.getOwnPropertyNames
              ...
              : [];
        n.exports.f = function getOwnPropertyNames(
          t
        ) {
          return u &&
            "[object Window]" == o.call(t)
            ? (function (t) {
                try {
                  return i(t);
                } catch (t) {
      ...
      function (t, n, r) {
        ...
        if (t(58)) {
          var y = t(89),
            ...
            qt = function getOwnPropertyDescriptor(
              t,
              n
            ) {
              return Bt(t, (n = a(n, !0)))
        ...
        var e = (function (o) {
          ...
          function wrap(t, n, r, e) {
            var i =
              ...
              u = new Context(e || []);
            return (
              (o._invoke = (function makeInvokeMethod(
                o,
                u,
                c
              ) {
...
function Curtains(t) {
  ...
  if (
    ...
    (null !== this._autoResize &&
      void 0 !== this._autoResize) ||
      (this._autoResize = !0),
    (this._autoRender = t.autoRender),
    (null !== this._autoRender &&
      void 0 !== this._autoRender) ||
      (this._autoRender = !0),
    (this._watchScroll = t.watchScroll),
    (null !== this._watchScroll &&
      void 0 !== this._watchScroll) ||
      (this._watchScroll = !0),
    (this.productionMode =
      t.production || !1),
    !this.container)
    ...
    return (
      this.productionMode ||
        console.warn(
          "You must specify a valid container ID"
        ),
      void (
...
(Curtains.prototype._init = function () {
  if (
    ((this.glCanvas = document.createElement(
      "canvas"
    )),
    (this.glContext =
  ...
  (this._loseContextExtension = this.glContext.getExtension(
    "WEBGL_lose_context"
  )),
    (this._contextLostHandler = this._contextLost.bind(
      this
    )),
    ...
    (this._contextRestoredHandler = this._contextRestored.bind(
      this
    )),
    this.glCanvas.addEventListener(
    ...
    this._watchScroll &&
      window.addEventListener(
        "scroll",
        this._scrollManager.handler,
        { passive: !0 }
      );
  var t = window.devicePixelRatio || 1;
  this.setPixelRatio(t, !1),
    (this._resizeHandler = null),
    this._autoResize &&
      ((this._resizeHandler = this.resize.bind(
        this,
        !0
      )),
      window.addEventListener(
  ...
  (Curtains.prototype.setPixelRatio = function (
    t,
    e
  ) {
    (this.pixelRatio =
      parseFloat(Math.max(t, 1)) || 1),
      this.resize(e);
  }),
  (Curtains.prototype._setSize = function () {
    ...
    (this.glCanvas.style.width =
      ...
      this._scrollManager.shouldWatch &&
        ((this._scrollManager.xOffset =
          window.pageXOffset),
        (this._scrollManager.yOffset =
          window.pageYOffset));
  }),
  ...
  (Curtains.prototype.resize = function (
    ...
    for (
      var e = 0;
      e < this.planes.length;
      e++
    )
      this.planes[e]._canDraw &&
        this.planes[e].planeResize();
    for (
      e = 0;
      e < this.shaderPasses.length;
      e++
    )
      this.shaderPasses[e]._canDraw &&
        this.shaderPasses[
          e
        ].planeResize();
    this.needRender();
  ...
  (Curtains.prototype._scroll = function () {
    ...
    if (
      (this.updateScrollValues(t.x, t.y),
      this._scrollManager.shouldWatch)
    ) {
      for (
        var e = 0;
  ...
  (Curtains.prototype.updateScrollValues = function (
    t,
    e
  ) {
    var i = this._scrollManager.xOffset;
    (this._scrollManager.xOffset = t),
      (this._scrollManager.lastXDelta =
        i - this._scrollManager.xOffset);
    var r = this._scrollManager.yOffset;
    (this._scrollManager.yOffset = e),
      (this._scrollManager.lastYDelta =
        r - this._scrollManager.yOffset);
  }),
  ...
  (Curtains.prototype._contextLost = function (
    t
  ) {
    t.preventDefault(),
  ...
  (Curtains.prototype._contextRestored = function () {
    for (
      var t = 0;
      t < this.planes.length;
      t++
    )
      this.planes[t]._restoreContext();
    for (
      t = 0;
      t < this.shaderPasses.length;
      t++
    )
      this.shaderPasses[
        t
  ...
  (Curtains.prototype.dispose = function () {
    for (; this.planes.length > 0; )
      this.removePlane(this.planes[0]);
    for (; this.shaderPasses.length > 0; )
      this.removeShaderPass(
        this.shaderPasses[0]
      );
    var t = this,
      e = setInterval(function () {
        0 === t.planes.length &&
          0 === t.shaderPasses.length &&
          (clearInterval(e),
          t.glContext.clear(
  ...
  (Curtains.prototype._createPlane = function (
    t,
    e
  ) {
    var i = new Curtains.Plane(
      this,
      t,
      e
    );
  ...
  (Curtains.prototype.addPlane = function (
    t,
    e
  ) {
  ...
  (Curtains.prototype.removePlane = function (
    t
  ) {
    (t._canDraw = !1), t && t._dispose();
    for (
      var e, i = this._drawStack, r = 0;
      r < i.length;
      r++
    )
      t.index === i[r] &&
        this._drawStack.splice(r, 1);
    for (
      r = 0;
      r < this.planes.length;
      r++
    )
      t.index === this.planes[r].index &&
        (e = r);
    (t = null),
      (this.planes[e] = null),
  ...
  (Curtains.prototype._stackPlane = function (
    t
  ) {
    this._drawStack.push(t);
  }),
  (Curtains.prototype._createShaderPass = function (
    t
  ) {
    var e = new Curtains.ShaderPass(
      this,
      t
    );
    return (
  ...
  (Curtains.prototype.addShaderPass = function (
    t
  ) {
    return this.glContext
      ? this._createShaderPass(t)
      : (this.productionMode ||
          console.warn(
            "Unable to create a plane. The WebGl context couldn't be created"
          ),
  ...
  (Curtains.prototype.removeShaderPass = function (
    t
  ) {
    var e;
    (t._canDraw = !1), t && t._dispose();
    for (
      var i = 0;
      i < this.shaderPasses.length;
      i++
    )
      t.index ===
        this.shaderPasses[i].index &&
        (e = i);
    (t = null),
      (this.shaderPasses[e] = null),
  ...
  (Curtains.prototype._handleDepth = function (
    t
  ) {
    (this._shouldHandleDepth = t),
      t
        ? this.glContext.enable(
            this.glContext.DEPTH_TEST
          )
        : this.glContext.disable(
            this.glContext.DEPTH_TEST
          );
  }),
  (Curtains.prototype._multiplyMatrix = function (
    t,
    e
  ) {
    var i = [],
  ...
  (Curtains.prototype._scaleMatrix = function (
    t,
    e,
    i,
    r
  ...
  (Curtains.prototype._applyTransformationsMatrix = function (
    t,
    e,
    i
  ) {
  ...
  (Curtains.prototype._applyMatrixToPoint = function (
    t,
    e
  ) {
    var i = t[0],
  ...
  (Curtains.prototype.onAfterResize = function (
    t
  ) {
    return (
      t &&
        (this._onAfterResizeCallback = t),
      this
    );
  }),
  (Curtains.prototype.onError = function (
    t
  ) {
    return (
      t && (this._onErrorCallback = t),
      this
    );
  }),
  (Curtains.prototype.onContextLost = function (
    t
  ) {
    return (
      t &&
        (this._onContextLostCallback = t),
      this
    );
  }),
  (Curtains.prototype.onContextRestored = function (
    t
  ) {
    return (
      t &&
        (this._onContextRestoredCallback = t),
      this
    );
  }),
  (Curtains.prototype.onRender = function (
    t
  ) {
    return (
      t && (this.__onRenderCallback = t),
      this
    );
  }),
  (Curtains.prototype.onScroll = function (
    t
  ) {
    return (
      t && (this._onScrollCallback = t),
      this
    );
  }),
  (Curtains.BasePlane = function (
    t,
    e,
    i
  ) {
    (this._type = "BasicPlane"),
      (this._wrapper = t),
      (this.htmlElement = e),
      this._initBasePlane(e, i);
  }),
  (Curtains.BasePlane.prototype._initBasePlane = function (
    t,
    e
  ) {
    e || (e = {}),
      ...
      (this._definition = {
        width:
          parseInt(e.widthSegments) || 1,
        height:
          parseInt(e.heightSegments) || 1,
      }),
  ...
  (Curtains.BasePlane.prototype._setDefaultVS = function (
    t
  ) {
    return (
      this._wrapper.productionMode ||
  ...
  (Curtains.BasePlane.prototype._createShader = function (
    t,
    e
  ) {
  ...
  (Curtains.BasePlane.prototype._setupPlaneProgram = function () {
    ...
    return (
      ...
      (this._shaders.vertexShader = this._createShader(
        this._shaders.vertexShaderCode,
        i.VERTEX_SHADER
      )),
      (this._shaders.fragmentShader = this._createShader(
        this._shaders.fragmentShaderCode,
        i.FRAGMENT_SHADER
      )),
      (this._shaders.vertexShader &&
        this._shaders.fragmentShader) ||
        (e.productionMode ||
          console.warn(
      ...
      t &&
        ...
        e.productionMode ||
          ...
          (t = !1))),
      (this._isProgramValid = t),
      t
    );
  }),
  (Curtains.BasePlane.prototype._handleUniformSetting = function (
    t,
    e,
    i
  ) {
    var r = this._wrapper.glContext;
    switch (t) {
      case "1i":
        r.uniform1i(e, i);
        break;
      ...
      default:
        this._wrapper.productionMode ||
          console.warn(
            "This uniform type is not handled : ",
            t
          );
    }
  }),
  (Curtains.BasePlane.prototype._setUniforms = function (
    ...
    var r = this;
    t &&
      Object.keys(t).map(function (a, s) {
        var n = t[a];
        (n.location = i.getUniformLocation(
          r._program,
          n.name
        )),
          n.type ||
  ...
  (Curtains.BasePlane.prototype._setAttributes = function () {
    this._attributes ||
      ...
      (this._attributes.vertexPosition = {
        ...
        location: this._wrapper.glContext.getAttribLocation(
          this._program,
          "aVertexPosition"
        ),
      }),
    ...
    for (
      ...
      for (
        ...
        this._material.uvs.push(r),
          ...
          this._material.uvs.push(
            r + 1 / this._definition.width
          ),
          this._material.uvs.push(e),
          this._material.uvs.push(0),
          this._geometry.vertices.push(
  ...
  (Curtains.BasePlane.prototype._restoreContext = function () {
    if (
      ...
      for (
        ...
        "texturePass" ===
        this.textures[t].type
          ? this.textures[
              t
            ]._initShaderPassTexture()
          : (this.textures[t]._init(),
            this.textures[t].setSource(
              e
            ));
      }
      "Plane" === this._type
  ...
  (Curtains.BasePlane.prototype.getBoundingRect = function () {
    return {
      width: this._boundingRect.document
        .width,
      height: this._boundingRect.document
        .height,
      top: this._boundingRect.document
        .top,
      left: this._boundingRect.document
        .left,
      right:
  ...
  (Curtains.BasePlane.prototype.getWebGLBoundingRect = function () {
    ...
    if (e) {
      ...
      return {
        width:
          (a - r) * t._boundingRect.width,
        height:
          (n - s) *
          t._boundingRect.height,
        top:
          s * t._boundingRect.height +
          t._boundingRect.top,
        left:
          r * t._boundingRect.width +
          t._boundingRect.left,
        right:
          r * t._boundingRect.width +
          t._boundingRect.left +
          (a - r) * t._boundingRect.width,
  ...
  (Curtains.BasePlane.prototype.planeResize = function () {
    ...
    "ShaderPass" === this._type &&
      (this._wrapper.glContext.bindFramebuffer(
        this._wrapper.glContext
          .FRAMEBUFFER,
        this._frameBuffer
      ),
    ...
    var e = this;
    setTimeout(function () {
      e._onAfterResizeCallback &&
        e._onAfterResizeCallback();
    });
  }),
  (Curtains.BasePlane.prototype.createTexture = function (
    t,
    e
  ) {
    var i = new Curtains.Texture(this, {
  ...
  (Curtains.BasePlane.prototype.loadSources = function (
    t
  ) {
    for (var e = 0; e < t.length; e++)
      this.loadSource(t[e]);
  }),
  (Curtains.BasePlane.prototype.loadSource = function (
    t
  ) {
  ...
  (Curtains.BasePlane.prototype.loadImage = function (
    t
  ) {
    var e = t;
    (e.crossOrigin =
    ...
    (i._onSourceLoadedHandler = i._onSourceLoaded.bind(
      i,
      e
    )),
      e.addEventListener(
        "load",
        i._onSourceLoadedHandler,
        !1
      ),
      e.complete && i._onSourceLoaded(e),
      this.images.push(e);
  }),
  (Curtains.BasePlane.prototype.loadVideo = function (
    t
  ) {
    var e = t;
    (e.preload = !0),
      ...
      (e.crossOrigin =
        this.crossOrigin || "anonymous");
    var i = this.createTexture(e.sampler);
    (i._onSourceLoadedHandler = i._onVideoLoadedData.bind(
      i,
      e
    )),
      e.addEventListener(
  ...
  (Curtains.BasePlane.prototype.loadCanvas = function (
    t
  ) {
    var e = t;
    e.sampler =
  ...
  (Curtains.BasePlane.prototype.loadImages = function (
    t
  ) {
    for (var e = 0; e < t.length; e++)
      this.loadImage(t[e]);
  }),
  (Curtains.BasePlane.prototype.loadVideos = function (
    t
  ) {
    for (var e = 0; e < t.length; e++)
      this.loadVideo(t[e]);
  }),
  (Curtains.BasePlane.prototype.loadCanvases = function (
    t
  ) {
    for (var e = 0; e < t.length; e++)
      this.loadCanvas(t[e]);
  ...
  (Curtains.BasePlane.prototype.mouseToPlaneCoords = function (
    t,
    e
  ) {
    var i = this.scale
  ...
  (Curtains.BasePlane.prototype._bindPlaneTexture = function (
    t
  ) {
    ...
    (this.textures = null),
      t &&
        ...
        this._material &&
          ...
          (this._material = null)),
        this._frameBuffer &&
          (this._wrapper.glContext.deleteFramebuffer(
            this.framebuffer
          ),
          (this.framebuffer = null)),
        this._depthBuffer &&
          (this._wrapper.glContext.deleteRenderbuffer(
            this._depthBuffer
          ),
          (this._depthBuffer = null)),
        this._shaders &&
          ...
          (this._shaders = null)),
        this._program &&
          (t.deleteProgram(this._program),
          (this._program = null)));
  }),
  (Curtains.BasePlane.prototype.onAfterResize = function (
    t
  ) {
    return (
      t &&
  ...
  (Curtains.BasePlane.prototype.onLoading = function (
    t
  ) {
    return (
      t &&
        (this._onPlaneLoadingCallback = t),
      this
    );
  }),
  (Curtains.BasePlane.prototype.onReady = function (
    t
  ) {
    return (
      t && (this._onReadyCallback = t),
      this
    );
  }),
  (Curtains.BasePlane.prototype.onRender = function (
    t
  ) {
    return (
      t && (this._onRenderCallback = t),
      this
    );
  }),
  (Curtains.Plane = function (t, e, i) {
    Curtains.BasePlane.call(
      this,
      t,
      e,
      i
  ...
  (Curtains.Plane.prototype = Object.create(
    Curtains.BasePlane.prototype
  )),
  (Curtains.Plane.prototype.constructor =
    Curtains.Plane),
  (Curtains.Plane.prototype._setInitParams = function (
    t
  ) {
    var e = this._wrapper;
    ...
    t.drawCheckMargins &&
      (i = t.drawCheckMargins),
      (this.drawCheckMargins = i),
      (this.rotation = {
        x: 0,
        y: 0,
        z: 0,
      ...
      (this.autoloadSources =
        t.autoloadSources),
      (null !== this.autoloadSources &&
        void 0 !==
          this.autoloadSources) ||
        (this.autoloadSources = !0),
      (this._fov = t.fov || 75),
      null === t.watchScroll ||
      void 0 === t.watchScroll
        ? (this.watchScroll = this._wrapper._watchScroll)
        : (this.watchScroll =
            t.watchScroll || !1),
      this.watchScroll &&
        (this._wrapper._scrollManager.shouldWatch = !0),
  ...
  (Curtains.Plane.prototype._initSources = function () {
    if (this.autoloadSources) {
      for (
        var t = [], e = 0;
        e <
        this.htmlElement.getElementsByTagName(
          "img"
        ).length;
        e++
      )
    ...
    (a = setInterval(function () {
      s._loadingManager.sourcesLoaded >=
        s._loadingManager
          .initSourcesToLoad &&
        (clearInterval(a),
        s._onReadyCallback &&
  ...
  (Curtains.Plane.prototype._setComputedSizes = function () {
    var t = this._wrapper,
      ...
      i =
        ...
        this._boundingRect.document.top,
      r =
        t._boundingRect.width / 2 +
        t._boundingRect.left,
      a =
        t._boundingRect.height / 2 +
        t._boundingRect.top;
    this._boundingRect.computed = {
      width:
        this._boundingRect.document
          .width / t._boundingRect.width,
      height:
        this._boundingRect.document
          .height /
        t._boundingRect.height,
      top:
        (a - i) / t._boundingRect.height,
      left:
        (e - r) / t._boundingRect.height,
    };
  }),
  ...
  (Curtains.Plane.prototype.setPerspective = function (
    t,
    e,
    i
  ) {
    ...
    this._matrices &&
      ...
      this._wrapper.glContext.useProgram(
        this._program
      ),
  ...
  (Curtains.Plane.prototype._setMVMatrix = function () {
    var t = this._wrapper,
      ...
      a = [e.x, e.y, 1];
    this._matrices &&
      ((this._matrices.mvMatrix.matrix = t._applyTransformationsMatrix(
        i,
        r,
        a
      )),
      ...
      (this._matrices.viewProjectionMatrix = t._multiplyMatrix(
        this._matrices.pMatrix.matrix,
        this._matrices.mvMatrix.matrix
      ))),
      !this.alwaysDraw &&
  ...
  (Curtains.Plane.prototype.setScale = function (
    t,
    e
  ) {
    if (
  ...
  (Curtains.Plane.prototype.setRotation = function (
    t,
    e,
    i
  ) {
  ...
  (Curtains.Plane.prototype._setTranslation = function () {
    ...
    (0 === this.relativeTranslation.x &&
      ...
      (this._translation.x =
        this._boundingRect.computed.left +
        t.x),
      (this._translation.y =
        this._boundingRect.computed.top +
        t.y),
      this._setMVMatrix();
  }),
  (Curtains.Plane.prototype.setRelativePosition = function (
    t,
    e
  ) {
    (this.relativeTranslation = {
  ...
  (Curtains.Plane.prototype._documentToPlaneSpace = function (
    t,
    e
  ) {
    var i = this._wrapper;
    return {
      x:
        (t /
          (i._boundingRect.width /
            i.pixelRatio)) *
        (i._boundingRect.width /
          i._boundingRect.height),
      y:
        -e /
        (i._boundingRect.height /
          i.pixelRatio),
  ...
  (Curtains.Plane.prototype._shouldDrawCheck = function () {
    ...
    e.top >
      ...
      ? this._shouldDraw &&
        ((this._shouldDraw = !1),
        setTimeout(function () {
          i._onLeaveViewCallback &&
            i._onLeaveViewCallback();
        }, 0))
      : (this._shouldDraw ||
          setTimeout(function () {
            i._onReEnterViewCallback &&
              i._onReEnterViewCallback();
          }, 0),
        (this._shouldDraw = !0));
  }),
  ...
  (Curtains.Plane.prototype.enableDepthTest = function (
    t
  ) {
  ...
  (Curtains.Plane.prototype.moveToFront = function () {
    ...
    for (
      var t = this._wrapper._drawStack,
        e = 0;
      e < t.length;
      e++
    )
  ...
  (Curtains.Plane.prototype.onReEnterView = function (
    t
  ) {
    return (
      t &&
        (this._onReEnterViewCallback = t),
      this
    );
  }),
  (Curtains.Plane.prototype.onLeaveView = function (
    t
  ) {
    return (
      t &&
        (this._onLeaveViewCallback = t),
      this
    );
  }),
  ...
  (Curtains.ShaderPass.prototype = Object.create(
    Curtains.BasePlane.prototype
  )),
  (Curtains.ShaderPass.prototype.constructor =
    Curtains.ShaderPass),
  ...
  (Curtains.ShaderPass.prototype._setDefaultVS = function (
    t
  ) {
  ...
  (Curtains.ShaderPass.prototype._setDefaultFS = function (
    t
  ) {
  ...
  (Curtains.ShaderPass.prototype._createFrameBuffer = function () {
    ...
    (this._frameBuffer = t.createFramebuffer()),
      ...
      (this._depthBuffer = t.createRenderbuffer()),
      this._bindDepthBuffer();
  }),
  ...
  (Curtains.Texture.prototype._init = function () {
    ...
    var i =
      this._sampler.name ||
      "uSampler" + this.index;
    (this._sampler.location = t.getUniformLocation(
      e._program,
      i
    )),
      t.uniform1i(
        this._sampler.location,
        this.index
      );
    var r = this._sampler.name
    ...
    (this._textureMatrix = {
      ...
      matrix: null,
      location: t.getUniformLocation(
        this._plane._program,
        r
      ),
    }),
      (this._sampler.name = i);
  }),
  (Curtains.Texture.prototype._initShaderPassTexture = function () {
    var t = this._wrapper.glContext;
    (this.type = "texturePass"),
      (this._size = {
        width: this._plane._boundingRect
          .document.width,
        height: this._plane._boundingRect
          .document.height,
      }),
      (this._sampler.texture = t.createTexture()),
      t.bindTexture(
      ...
      t.useProgram(this._plane._program),
      (this._sampler.location = t.getUniformLocation(
        this._plane._program,
        this._sampler.name
      )),
  ...
  (Curtains.Texture.prototype.setSource = function (
    t
  ) {
  ...
  (Curtains.Texture.prototype._getSizes = function () {
    var t = this._plane.scale
        ? this._plane.scale
        : { x: 1, y: 1 },
      e =
        this._plane._boundingRect.document
          .width * t.x,
      i =
        this._plane._boundingRect.document
          .height * t.y,
  ...
  (Curtains.Texture.prototype.setScale = function (
    t,
    e
  ) {
    (t = parseFloat(t) || 1),
  ...
  (Curtains.Texture.prototype._updateTextureMatrix = function (
    t
  ) {
    var e = {
      x:
        t.planeWidth /
        (t.planeWidth - t.xOffset),
      y:
        t.planeHeight /
        (t.planeHeight - t.yOffset),
    };
    (e.x /= this.scale.x),
      (e.y /= this.scale.y);
  ...
  (Curtains.Texture.prototype._onSourceLoaded = function (
    t
  ) {
    this._plane._loadingManager
      .sourcesLoaded++,
      this.setSource(t);
    var e = this;
    this._sourceLoaded ||
      setTimeout(function () {
        e._plane
          ._onPlaneLoadingCallback &&
          e._plane._onPlaneLoadingCallback();
      }, 0),
      (this._sourceLoaded = !0);
  }),
  (Curtains.Texture.prototype._onVideoLoadedData = function (
    t
  ) {
    this._sourceLoaded ||
      this._onSourceLoaded(t);
  }),
    ...
    this._plane._bindPlaneTexture(this),
      "video" === this.type &&
        ...
        this.source.readyState >=
          this.source.HAVE_CURRENT_DATA &&
        !this.source.paused &&
        this.source.currentTime > 0 &&
        !this.source.ended &&
        (this._willUpdate = !this
          ._willUpdate),
      this._willUpdate &&
        this.shouldUpdate &&
        this._update();
...
window.onload = function () {
  ...
  var planeElement = document.getElementsByClassName(
    "curtain"
  );
  ...
  for (
    var i = 0;
    i < planeElement.length;
    i++
  ) {
    planes.push(
      webGLCurtain.addPlane(
        planeElement[i],
        params
      )
    );
  ...
  function handleMovement(e, plane) {
    ...
    plane.uniforms.mouseStrength.value =
      1 -
      Math.sqrt(
        Math.pow(mouseCoords.x, 2) +
          Math.pow(mouseCoords.y, 2)
      ) /
        4;
  }
};
...
!(function (a, b) {
  ...
  var c = {},
    d = a.document,
    e = (a.GreenSockGlobals =
      a.GreenSockGlobals || a),
    f = e[b];
  if (f)
    return (
  ...
  for (
    ...
    (A =
      a[g[h] + "RequestAnimationFrame"]),
      (B =
        a[
          g[h] + "CancelAnimationFrame"
        ] ||
        a[
          g[h] +
  ...
  var E = u("core.Animation", function (
    a,
    b
  ) {
    if (
  ...
  F(),
    ...
    (i.progress = i.totalProgress = function (
      a,
      b
    ) {
      var c = this.duration();
  ...
  (Z._startTime = j.time),
    ...
    (E._updateRoot = H.render = function () {
      ...
      if (
        ...
        $ =
          j.frame +
          (parseInt(H.autoSleep, 10) ||
            120);
        for (c in U) {
          for (
            b = U[c].tweens, a = b.length;
            --a > -1;
  ...
  (i._init = function () {
      ...
      for (g in this.vars)
        if (((l = this.vars[g]), W[g]))
          l &&
            ...
            (this.vars[
              g
            ] = l = this._swapSelfInParams(
              l,
              this
            ));
        else if (
          T[g] &&
          (j = new T[g]())._onInitTween(
            b,
            this.vars[g],
            this,
            f
    ...
    (H.killTweensOf = H.killDelayedCallsTo = function (
      a,
      b,
      c
    ) {
  ...
  if (
    ...
    for (i in r)
      r[i].func ||
        a.console.log(
          "GSAP encountered missing dependency: " +
            i
        );
  }
  k = !1;
...
!(function (t, e) {
  ...
  (function (t, e) {
    ...
    return (
      ...
      (o.prototype.addImage = function (
        t
      ) {
        var e = new r(t);
        this.images.push(e);
      }),
      (o.prototype.addBackground = function (
        t,
        e
      ) {
        var i = new s(t, e);
...
var tippy = (function (t) {
  ...
  function st(t, e) {
    ...
    return (
      ...
      e.interactive && ot(r),
      e.arrow &&
        (r.setAttribute("data-arrow", ""),
        r.appendChild(ut(e.arrow))),
      e.inertia && it(r),
      at(p, e),
      r.appendChild(p),
      n.appendChild(r),
    ...
    (t.style.zIndex = "" + n.zIndex),
      ...
      (o.style.maxWidth =
        ...
        typeof (r = n.maxWidth)
          ...
          : r),
      n.role
        ? o.setAttribute("role", n.role)
        : o.removeAttribute("role"),
      e.content !== n.content && at(a, n),
      !e.arrow && n.arrow
        ? (o.appendChild(ut(n.arrow)),
          o.setAttribute(
            "data-arrow",
            ""
          ))
  ...
  function ht(r, i) {
    ...
    var s,
      ...
      E = 0,
      A = [],
      I = L(Dt, u.interactiveDebounce),
      F = H(u.triggerTarget || r),
      j = dt++,
      _ = st(j, u),
      W = pt(_),
      X = (v = u.plugins).filter(
        function (t, e) {
      ...
      $ = {
        ...
        show: function (t) {
          ...
          var e = $.state.isVisible,
            ...
            r = !$.state.isEnabled,
            i =
              q.isTouch && !$.props.touch;
          if (e || n || r || i) return;
          if (
            ut().hasAttribute("disabled")
          )
            return;
          $.popperInstance || St();
          if (
          ...
          At(),
            ...
            (function (t, e) {
              ...
              $.popperInstance.disableEventListeners(),
                ($.popperInstance.options.placement =
                  $.props.placement),
                _.parentNode.removeChild(
                  _
                ),
                0 ===
                  (mt = mt.filter(
    ...
    function St() {
      var n,
        i = $.props.popperOptions,
        o = $.popperChildren.arrow,
        a = w(i, "flip"),
...
!(function () {
    ...
    d = (function () {
      function e() {
        ...
        s(this, e),
          ...
          (this.checkScroll = this.checkScroll.bind(
            this
          )),
          (this.checkResize = this.checkResize.bind(
            this
          )),
          (this.instance = {
            scroll: { x: 0, y: 0 },
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.scrollToEls = this.el.querySelectorAll(
                ...
                (this.setScrollTo = this.setScrollTo.bind(
                  this
                )),
                this.scrollToEls.forEach(
                  function (t) {
                    t.addEventListener(
                      "click",
                      e.setScrollTo,
      ...
      (function () {
        (null !== e
          ...
          return (
              ...
              return (
                ...
                (t = t.originalEvent || t)
                  ...
                  : (null == t.detail &&
                      0 !== t.detail) ||
                    (e = -40 * t.detail),
                this.deltasTimestamp.push(
                  Date.now()
                ),
                this.deltasTimestamp.shift(),
                0 < e
                  ? (this.lastUpDeltas.push(
                      e
                    ),
                    this.lastUpDeltas.shift(),
                    this.isInertia(1))
                  : (this.lastDownDeltas.push(
                      e
                    ),
            ...
            (t.prototype.isInertia = function (
              t
            ) {
              var e, i, s, n, o, l, r;
              return null ===
  ...
  function H(t) {
    !(function (t) {
      if (!t)
        return console.warn(
          "bindAll requires at least one argument."
        );
  ...
  (H.prototype._notify = function (t) {
    ...
    (H.prototype._onWheel = function (t) {
      ...
      if (
        !this._lethargy ||
        !1 !== this._lethargy.check(t)
      ) {
        var i = this._event;
        (i.deltaX =
          t.wheelDeltaX || -1 * t.deltaX),
          (i.deltaY =
            t.wheelDeltaY ||
            -1 * t.deltaY),
          k.isFirefox &&
    ...
    (H.prototype._onMouseWheel = function (
      t
    ) {
      if (
        !this.options.limitInertia ||
    ...
    (H.prototype._onTouchStart = function (
      t
    ) {
    ...
    (H.prototype._onTouchMove = function (
      t
    ) {
      var e = this.options;
      e.preventTouch &&
        !t.target.classList.contains(
          e.unpreventTouchClass
        ) &&
        t.preventDefault();
      var i = this._event,
        s = t.targetTouches
          ...
          : t;
      (i.deltaX =
        (s.pageX - this.touchStartX) *
        e.touchMultiplier),
        (i.deltaY =
          (s.pageY - this.touchStartY) *
          e.touchMultiplier),
      ...
      return (
        ...
        o(n, [
          ...
          },
          {
            key: "initScrollBar",
            value: function () {
              (this.scrollbar = document.createElement(
                "span"
              )),
                (this.scrollbarThumb = document.createElement(
                  "span"
                )),
                ...
                (this.scrollBarLimit =
                  ...
                  this.scrollbarThumb.getBoundingClientRect()
                    .height),
                (this.getScrollBar = this.getScrollBar.bind(
                  this
                )),
                (this.releaseScrollBar = this.releaseScrollBar.bind(
                  this
                )),
                (this.moveScrollBar = this.moveScrollBar.bind(
                  this
                )),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (n -= this.instance.scroll
                .y),
                (this.instance.delta.y = Math.min(
                  n,
                  this.instance.limit
                )),
        ...
        polyfill: function () {
          ...
          if (
            !(
              ...
              !0 !==
                a.__forceSmoothScrollPolyfill__
            )
          ) {
            var t,
              e =
...
const container = document.querySelector(
  ...
  itemsWrapper = document.querySelector(
    ".grid"
  ),
  preloadImages = () =>
    new Promise((t, o) => {
...
const container1 = document.querySelector(
  ...
  itemsWrapper1 = document.querySelector(
    ".grid1"
  ),
  preloadImages1 = () =>
    new Promise((t, o) => {
...
preloadImages1().then(() => {
  ...
  tippy(".tip", {
    content:
      "<ul><li>User Interface</li><li>Responsive Design</li><li>Interaction Design</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-1", {
    content:
      "<ul><li>Functional <br>specs</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-2", {
    content:
      "<ul><li>Sketch</li><li>Photoshop</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-4", {
    content:
      "<ul><li>Drupal</li><li>Wordpress</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-5", {
    content:
      "<ul><li>Canvas</li><li>WebGL</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-6", {
    content:
      "<ul><li>D3.js</li><li>Highcharts</li><li>Chart.js</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-7", {
    content:
      "<ul><li>Gmaps</li><li>Carto</li><li>Polymaps</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-9", {
    content:
      "<ul><li>User Stories</li><li>Test plan</li><li>Github</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-11", {
    content:
      "<ul><li>Dev Tools</li><li>Lighthouse</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-12", {
    content:
      "<ul><li>Agile</li><li>Waterfall</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
  ...
  tippy(".tip-14", {
    content:
      "<ul><li>Gantt</li><li>Reports</li></ul>",
    placement: "bottom",
    arrow: !1,
    sticky: !0,
    followCursor: !0,
