...
(function (self, undefined) {
    ...
    if ("object" === Type(e)) {
      ...
      var r =
        "function" ==
          typeof self.Symbol &&
        "symbol" ==
          typeof self.Symbol.toPrimitive
          ? GetMethod(
              e,
              self.Symbol.toPrimitive
            )
          : undefined;
      if (r !== undefined) {
        var n = Call(r, e, [i]);
  ...
  if (!("document" in self)) {
    "undefined" ==
      ...
      (self.HTMLDocument
        ? (self.Document =
            self.HTMLDocument)
        : ((self.Document = self.HTMLDocument = document.constructor = new Function(
    ...
    !(function () {
      ...
      if (
        ...
        if (
          ...
          return void (window.HTMLElement =
            window.Element);
        ...
        var t,
          ...
          c = (Element.prototype = r.appendChild(
            r.createElement("*")
          )),
          d = {},
          m = function (e, t) {
        ...
        c.attachEvent(
          ...
          e() ||
            ...
            (t = setInterval(e, 25))),
          (document.createElement = function p(
            e
          ) {
            var t = i(
  ...
  if (
    ...
    !(function (e) {
      ...
      Object.defineProperty = function n(
        o,
        i,
        c
      ) {
  ...
  if (!("indexOf" in Array.prototype)) {
    CreateMethodProperty(
      ...
      function r(t) {
        ...
        for (; o < n; ) {
          if (
            HasProperty(e, ToString(o))
          ) {
            if (t === Get(e, ToString(o)))
              return o;
          }
          o += 1;
        }
        ...
        for (o = 0; o < i.length; o++) {
          ...
          for (
            ...
            try {
              ...
              b = Object.prototype.propertyIsEnumerable.call(
                l,
                y
              );
            }
    ...
    "undefined" ==
      ...
      (function (o) {
        o.constructor
          ...
          : ((o.Window = o.constructor = new Function(
  ...
  if (
    !(
      ...
      ("function" ==
        ...
        self.CustomEvent.toString().indexOf(
